...
Gitdown is written and maintained by Pieter Hintjens.  Please use the issue [tracker][] for all comments and errata.  This document was published on &date("dddd mmmm d, yyyy") at &time(), and generated by the magic of Gitdown from $(INPUT).
